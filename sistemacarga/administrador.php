...
if (isset($_GET['mensaje'])) {
    echo '<div style="padding: 10px; border: 1px solid; margin-bottom: 10px;">';
    switch ($_GET['mensaje']) {
        case 'exito':
            echo "<p style='color: green;'>Producto agregado exitosamente.</p>";
            break;
        case 'error_imagen':
            echo "<p style='color: red;'>Error al mover la imagen al servidor.</p>";
            break;
        case 'imagen_invalida':
            echo "<p style='color: red;'>No se recibió una imagen válida.</p>";
            break;
        case 'error_bd':
            echo "<p style='color: red;'>Error en la conexión o consulta con la base de datos.</p>";
            break;
        default:
            echo "<p style='color: orange;'>Mensaje desconocido.</p>";
            break;
    }
    echo '</div>';
}
